...
#ifndef RSLOG_LOGGER_LOG_FILE_OBJECT_H_
#define RSLOG_LOGGER_LOG_FILE_OBJECT_H_
...
#define MESSAGE_BUF_SIZE (1 * 1024 * 1024)
...
class LogFileObject : public google::base::Logger {
 ...
 private:
  ...
  uint32 file_length_;
  int message_buf_len_;
  unsigned int rollover_attempt_;
  int64 next_flush_time_;  // cycle count at which to flush log
  string hostname_;
  time_t last_log_file_creation_time_;
  ...
  void CompressWrite(const char *msg, int msg_len, FILE *file);
  bool CompressEnable();
  void FileClose();
};
...
#endif  // RSLOG_LOGGER_LOG_FILE_OBJECT_H_
