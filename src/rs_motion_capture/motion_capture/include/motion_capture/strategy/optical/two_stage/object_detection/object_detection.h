...
#ifndef MOTION_CAPTURE_STRATEGY_OPTICAL_TWO_STAGE_OBJECT_DETECTION_OBJECT_DETECTION_H
#define MOTION_CAPTURE_STRATEGY_OPTICAL_TWO_STAGE_OBJECT_DETECTION_OBJECT_DETECTION_H
...
public:
  using Ptr = std::shared_ptr<ObjectDetection>;

  ObjectDetection(const Bindings::Ptr& bindings_ptr, cudaStream_t stream)
  ...
  std::string name() const { return "ObjectDetection"; }

private:
  robosense::inference::InferEngine::Ptr infer_ptr_;
  ObjectDetectionPreprocess::Ptr preprocess_ptr_;
  ObjectDetectionPostprocess::Ptr postprocess_ptr_;
...
#endif //MOTION_CAPTURE_STRATEGY_OPTICAL_TWO_STAGE_OBJECT_DETECTION_OBJECT_DETECTION_H
